...
class MenuLateral(QFrame):
    def __init__(self, ao_clicar):
        ...
        self.tooltips_menu = {
            ...
            "relatorios": "Relat?rios\n\nAcompanhe o resumo mensal: entradas reais, contas pagas, pend?ncias e valores previstos a receber.",
        ...
        self.adicionar_botao(layout, "relatorios", "menu_relatorios.png", "Relat?rios")
