...
class TesteLFinanceIsolado(unittest.TestCase):
    ...
    def test_as_dez_telas_sao_construidas(self):
        ...
        self.assertEqual(
            ...
            {
                "tela_inicial", "pesquisar", "receitas", "a_receber", "gastos", "despesas",
    ...
    def test_atualizador_aceita_somente_instalador_oficial_da_versao(self):
        ...
        hash_esperado = "a" * 64
        nome_esperado = "LFinance_Setup_v2.0.11.exe"
        url_esperada = (
            "https://github.com/iuriloose/LFinance/releases/download/"
            f"v2.0.11/{nome_esperado}"
        )
        release = {
            "tag_name": "v2.0.11",
            "name": "LFinance 2.0.11",
            "body": "Melhorias de teste",
            "html_url": "https://github.com/iuriloose/LFinance/releases/tag/v2.0.11",
            "assets": [
                {
                    "name": nome_esperado,
                ...
                },
                {
                    ...
                    "browser_download_url": "https://github.com/iuriloose/LFinance/releases/download/v2.0.11/outro_programa.exe",
                },
                {
                    "name": nome_esperado,
        ...
        self.assertEqual(resultado.nova_versao, "2.0.11")
        ...
        class RespostaFake:
            ...
            def read(self):
                return json.dumps({
                    ...
                    "assets": [{
                        "name": "LFinance_Setup_v2.0.1.exe",
                        "browser_download_url": "http://github.com/iuriloose/LFinance/releases/download/v2.0.1/LFinance_Setup_v2.0.1.exe",
                    }],
                }).encode("utf-8")
